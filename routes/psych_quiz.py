...
def create_psych_data(user_id):
    ...
    psych_quiz.PgFinish_WHOQOL_1 = str(content['PgFinish_WHOQOL_1'])
    psych_quiz.PgFinish_WHOQOL_2 = str(content['PgFinish_WHOQOL_2'])
    psych_quiz.PgFinish_WHOQOL_3 = str(content['PgFinish_WHOQOL_3'])
    psych_quiz.PgFinish_WHOQOL_4 = str(content['PgFinish_WHOQOL_4'])
    psych_quiz.PgFinish_WHOQOL_5 = str(content['PgFinish_WHOQOL_5'])
    psych_quiz.PgFinish_WHOQOL_6 = str(content['PgFinish_WHOQOL_6'])
    psych_quiz.PgFinish_WHOQOL_7 = str(content['PgFinish_WHOQOL_7'])
    psych_quiz.PgFinish_WHOQOL_8 = str(content['PgFinish_WHOQOL_8'])
    ...
    psych_quiz.PgRT_WHOQOL_1 = str(content['PgRT_WHOQOL_1'])
    psych_quiz.PgRT_WHOQOL_2 = str(content['PgRT_WHOQOL_2'])
    psych_quiz.PgRT_WHOQOL_3 = str(content['PgRT_WHOQOL_3'])
    psych_quiz.PgRT_WHOQOL_4 = str(content['PgRT_WHOQOL_4'])
    psych_quiz.PgRT_WHOQOL_5 = str(content['PgRT_WHOQOL_5'])
    psych_quiz.PgRT_WHOQOL_6 = str(content['PgRT_WHOQOL_6'])
    psych_quiz.PgRT_WHOQOL_7 = str(content['PgRT_WHOQOL_7'])
    psych_quiz.PgRT_WHOQOL_8 = str(content['PgRT_WHOQOL_8'])
    ...
    psych_quiz.WHOQOL_1= str(content['WHOQOL_1'])
    psych_quiz.WHOQOL_2= str(content['WHOQOL_2'])
    psych_quiz.WHOQOL_3= str(content['WHOQOL_3'])
    psych_quiz.WHOQOL_4= str(content['WHOQOL_4'])
    psych_quiz.WHOQOL_5= str(content['WHOQOL_5'])
    psych_quiz.WHOQOL_6= str(content['WHOQOL_6'])
    psych_quiz.WHOQOL_7= str(content['WHOQOL_7'])
    psych_quiz.WHOQOL_8= str(content['WHOQOL_8'])
